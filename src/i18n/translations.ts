...
export const copy: Record<Lang, Copy> = {
  en: {
    ...
    expertiseCards: [
      ...
      },
      {
        ...
        bullets: [
          "Limited-Edition & Event Product",
          "Gift Set & Bundling Design",
  ...
  zh: {
    ...
    expertiseCards: [
      {
        title: "策略设计",
        bullets: ["品牌战略咨询", "品牌视觉形象", "核心产品与包装设计", "材料选择及成本规划"],
      },
      {
        title: "品牌激活",
        bullets: ["活动限定产品", "礼盒组合设计", "线下品牌体验", "精确控制预算"],
      },
      {
        title: "一站式交付",
        bullets: ["供应商筛选与协调", "打样与样品制作", "工厂生产管理", "质检与交付"],
      },
      {
        title: "全球视野",
        bullets: ["国际化设计视野", "中国供应链网络", "跨境交付", "规模化成本控制"],
      },
    ],
    casesTitle: "案例与场景",
    casesDesc:
